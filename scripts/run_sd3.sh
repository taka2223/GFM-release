...
# --- 基础路径配置 ---
IMG_A="/cns/USERS/zzhixuan/data/MorphBench/Metamorphosis/scream_0.png"
IMG_B="/cns/USERS/zzhixuan/data/MorphBench/Metamorphosis/scream_1.png"
OUTPUT_DIR="./output/sd3_interp"
